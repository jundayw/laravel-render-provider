 ...
 * @method static RenderFactory success(string $message = null, string $url = null, mixed $data = null)
 * @method static RenderFactory error(string $error = null, string $url = null, mixed $errors = null)
 *
